...
league_avg_per_game_stats %>% 
  ...
  annotate("text",
           ...
           label = "Stephen Curry \nDrafted in \n2009",
           fontface = 3) +
  labs(title = "League Average of 3-Point Attempts per Game",
       x = "",
       y = "Attempts per Game") +
...
three_player_career_regular_season_per_game %>% 
  ...
  annotate("text",
           ...
           colour = "#1D428A",
           fontface = 4) +
  labs(title = "Average Per Game 3-Point Pecentage per Season",
...
three_player_career_regular_season_totals %>% 
  ...
  annotate("text",
           ...
           colour = "#1D428A",
           fontface = 4) +
  labs(title = "3-Point Field Goals Made per Season",
       y = "",
       x = "") +
  scale_color_manual(values=c("#FDBB30", "#CE1141", "#1D428A")) + #(Lebron, Jordan, Curry)
  theme_tufte() +
